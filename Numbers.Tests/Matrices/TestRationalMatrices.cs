...
namespace Numbers.Matrices.Tests
{
    ...
    {
        public static RM TwoByTwoIdentity = new RM(new R[][] {new R[] {1, 0}, new R[] {0, 1}});
        ...
        public static RM ThreeByThreeIdentity => new RM(new R[][] {new R[] {1, 0, 0}, new R[] {0, 1, 0}, new R[] {0, 0, 1}});
        public static RM ThreeByThree => new RM(new R[][] {new R[] {10, 4, -1}, new R[] {-7, -4, 0}, new R[] {1, 16, 10}});
        public static RM ThreeByThreeInv => new RM(new R[][] {new R[] {40, 56, 4}, new R[] {-70, -101, -7}, new R[] {108, 156, 12}}) * new R(1, 12);
        ...
        public static readonly R[][] QInv = {new R[] {new R(-3, 13), new R(1, 13)}, new R[] {new R(-2, 13), new R(5, 13)}};

        public static readonly R[][] r = new R[][] {new R[] {1, 0, 2}, new R[] {0, -1, -1}, new R[] {2, -1, 2}};
        public static readonly R[][] RInv = new R[][] {new R[] {-3, -2, 2}, new R[] {-2, -2, 1}, new R[] {2, 1, -1}};
